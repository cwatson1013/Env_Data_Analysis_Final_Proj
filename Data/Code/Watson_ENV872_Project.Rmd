...
```{r, fig.height = 6, fig.width = 6, warning = FALSE, fig.cap="\\label{fig:fig1} QQplot showing whether data for dissolved organic carbon is normally distributed."}
#qqplot of doc to see if there is a normal relationship
qqnorm(carbon.data.skinny$doc) 
qqline(carbon.data.skinny$doc)
```

```{r, fig.height = 6, fig.width = 6, warning = FALSE, fig.cap="\\label{fig:fig2} Log QQplot of dissolved organic carbon data."}
...
```{r, fig.height = 6, fig.width = 6, warning = FALSE, fig.cap="\\label{fig:fig5} Dissolved Organic Carbon Varying with depth section of each lake. Depth increases from left to right in graph, with Epilimnion being the surface of the lake."}
...
```{r, fig.height = 6, fig.width = 4.5, warning = FALSE, echo=FALSE, eval=TRUE, fig.cap="\\label{fig:fig7} Dissolved organic carbon concentration over time with year on the x-axis."}
