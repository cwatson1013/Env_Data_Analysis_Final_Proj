...
knitr::opts_chunk$set(echo = TRUE, eval = TRUE, fig.path = 'myproject/plot-',
...
#mk.test on West Long Lake
#mk.test(carbon.west2$doc[83:84]) #this cannot be run because there must be at least 3 elements
