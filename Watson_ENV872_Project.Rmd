...
<Note: set up autoreferencing for figures and tables in your document> <\autoref{figurelabel}>

```{r setup, include=FALSE, warning=FALSE, message=FALSE}
# Set your working directory
setwd("/Users/carolinewatson/Documents/Spring 2019/Environmental Data Analytics/Final_Project")
...
#frequency polygon graph looking at DIC in each lake
ggplot(carbon.data) + 
  geom_freqpoly(aes(x = carbon.data$DIC_mg, 
